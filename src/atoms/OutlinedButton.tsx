...
S.Button = styled.button<any>`
  ...
  border-radius: 100px;
  border: 2px solid ${({ inverted, theme }) => (inverted ? theme.color.negative : theme.color.primary)};
  font-size: 1.15rem;
  min-width: 44px;
  background-color: ${({ transparent, inverted, theme }) =>
    transparent ? 'transparent' : inverted ? theme.color.primary : theme.color.negative};
  color: ${({ transparent, theme }) => (transparent ? theme.color.negative : theme.color.primary)};
  ...
  &:hover {
    ...
    background-color: ${({ inverted, theme }) => (inverted ? theme.color.negative : theme.color.primary)};

    svg {
      fill: ${({ inverted, theme }) => (inverted ? theme.color.primary : theme.color.negative)};
    }
  }
